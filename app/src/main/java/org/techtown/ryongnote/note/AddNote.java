...
public class AddNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteTitle = findViewById(R.id.addNoteTitle);  // activity_add_note.xml
        noteContent = findViewById(R.id.addNoteContent);  // content_add_note.xml
    ...
    // 기존에 메뉴바에 있는 뒤로가기 버튼 대신 오른쪽에 x 버튼을 추가하여 클릭시 메인 화면으로 돌아오도록 만든다.
    @Override
