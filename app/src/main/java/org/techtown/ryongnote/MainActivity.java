package org.techtown.ryongnote;
...
import org.techtown.ryongnote.auth.Login;
import org.techtown.ryongnote.auth.Register;
import org.techtown.ryongnote.model.Adapter;
import org.techtown.ryongnote.model.Note;
import org.techtown.ryongnote.note.AddNote;
import org.techtown.ryongnote.note.EditNote;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fStore = FirebaseFirestore.getInstance();  // getInstance() : 데이터베이스의 인스턴스를 검색하고 쓰려는 위치를 참조한다.
